const candidates = {
  ...
  function login() {
    ...
    // For demonstration, assuming "1234" as the password.
    if (password !== "1234") {
      alert("Incorrect password.");
      return screen('voting.html');
    }
    ...
    // Hide login form and show respective section
  ...
  function showStudentVoting() {
    ...
    // Render department positions and candidates
    ...
    // Render USG positions and candidates
  ...
  document.getElementById('loginForm').addEventListener('submit', function(event) {
    ...
    // Assuming "1234" is the correct password for demo purposes
    if (password !== "1234") {
      alert('Incorrect password.');
      return;
    }

    // Create user object and save in localStorage
    const currentUser = { id, password, department, role: 'student' };  // Example: role can be 'student' or 'comelec'
